                    ...
                    <div className="interactions-polytic__wrapperTwo" style={{transform: mobileSwitcherButton ? 'translateX(-340px)' : 'translateX(0px)'}}>
                        ...
                        <div className="interactions-polytic__wrapperTwo-item">
                            ...
                            <div className="interactions-polytic__wrapperTwo-item-block">
                                ...
                                Предоставление информации об услугах, управление личным кабинетом на сайте и в приложении, идентификация при оплате услуг, при бронировании переговорных комнат, учёта баланса субъекта ПД и объёма оказываемых услуг Оператором, создание информационных рассылок
                                </div>
                            </div>
                        </div>
                        <div className="interactions-polytic__wrapperTwo-item">
                            ...
                            <div className="interactions-polytic__wrapperTwo-item-block">
                                <div className="interactions-polytic__wrapperTwo-item-block-descr">
                                Управление личным кабинетом на сайте и в приложении, идентификация при оплате услуг, при бронировании переговорных комнат
                                </div>
                            </div>
                        </div>
                        <div className="interactions-polytic__wrapperTwo-item">
